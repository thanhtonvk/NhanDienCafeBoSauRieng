...
class SauRiengPage extends StatefulWidget {
  const SauRiengPage({super.key});

  @override
  State<SauRiengPage> createState() => _SauRiengPageState();
}

class _SauRiengPageState extends State<SauRiengPage> {
  File? _imageFile;
  ...
  Future<void> _uploadImage() async {
    ...
    try {
      var request = http.MultipartRequest(
        'POST',
        Uri.parse('http://139.99.116.68:5000/api/la-sau-rieng'), // Thay API Flask URL
      );
      request.files
